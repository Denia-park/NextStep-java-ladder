...
* [사다리 게임](#사다리-게임)
  ...
  * [Step4](#step4)
    ...
    * [기능목록](#기능목록-3)
    * [23.11.25 추가 피드백 사항](#231125-추가-피드백-사항)
...
- 책임 주도 설계
  ...
  - [X] ~~IndexHorizontalMover[][] 대신에 컬렉션을 사용하자.~~
  ...
  - [X] ~~buildRow에서 initMovers만 따로 하지 말고 초기화 해서 List를 넘겨주자~~
  - [X] ~~List<Mover> 컬렉션을 이용해서 로우를 모두 생성하도록 하자.~~
    - 타입 컨버팅의 사용보다는 객체를 생성하는 곳에서는 구체적인 클래스를 이용해 생성하고, 사용하는 곳에서는 인터페이스를 이용해서 변경이 쉽도록 관리
